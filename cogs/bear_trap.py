            ...
            if search_term and not self.filtered_options:
                ...
                async def reset_callback(reset_interaction):
                    ...
                    await reset_interaction.response.edit_message(
                        content="Filter reset. Select a notification:",
                        view=new_view
                    )
                ...
                await modal_interaction.response.edit_message(
                    content=f"❌ No results found for '{search_term}'. Please try a different search term.",
...
class BearTrapView(discord.ui.View):
    ...
    async def remove_notification_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            ...
            await interaction.response.send_message(
                "Select a notification to remove (use Search button to filter):",
                view=view,
                ephemeral=True
            )
    ...
    async def view_notifications_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
                    ...
                    if embed_data:
                        ...
                        async def back_callback(back_interaction):
                            ...
                            await back_interaction.response.edit_message(
                                content="Select a notification to view details (use Search button to filter):",
                                embeds=[],
                                view=new_view
                            )
            ...
            await interaction.response.send_message(
                "Select a notification to view details (use Search button to filter):",
                view=view,
                ephemeral=True
            )
    ...
    async def toggle_notifications_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            ...
            await interaction.response.send_message(
                "Select a notification to toggle (use Search button to filter):",
                view=view,
                ephemeral=True
            )
    ...
    async def edit_notification_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            ...
            await interaction.response.send_message(
                "Select the notification you want to edit (use Search button to filter):",
                view=view,
                ephemeral=True
            )
